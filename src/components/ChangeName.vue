<template>
  <div class="changeNameView">
    <div :class="{ ChangeNameModal: !isClosing, ChangeNameModalClose: isClosing }">
      <div class="close" @click="closing();"></div>
      <h1 class="title">Cambia tu nombre de usuario</h1>
      <input type="text" placeholder="Inserta tu nuevo nombre de usuario" class="inputNewName">
      <div>
